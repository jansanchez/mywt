module.exports = function (context, done) {
    ...
    */
    ...
    @author Jan Sanchez
    */
    var CssUrlVersioner = function(settings) {
      this.sha1 = null;
      this.version = null;
    ...
    @author Jan Sanchez
    */
    var cssVersioned = new CssUrlVersioner({content: context.data.css});
    console.log(cssVersioned.output);
    return cssVersioned.output;
  }());
};